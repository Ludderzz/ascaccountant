  ...
  const servicesList = [
    {
      ...
      description: "We maintain accurate, up-to-date financial records for your business throughout the year. This includes recording income and expenditure, reconciling bank accounts, and keeping everything organised so that year-end is never a headache.",
    ...
    },
    {
      ...
      description: "We prepare and file self-assessment returns for sole traders, landlords, directors, and anyone else who needs to report income to HMRC. We make sure you claim everything you're entitled to and never miss a deadline.",
    ...
    },
    {
      ...
      description: "We handle the preparation and filing of your statutory annual accounts with Companies House, along with your Corporation Tax return to HMRC. All filings are completed on time and in plain English — you'll know exactly what the numbers mean.",
    ...
    },
    {
      ...
      description: "We prepare and file your quarterly VAT returns under Making Tax Digital (MTD) rules, handle VAT registration when your turnover reaches the threshold, and advise on the most appropriate VAT scheme for your business.",
    ...
    },
    {
      ...
      title: "Payroll",
      icon: <Users size={28} />,
      description: "We run your monthly payroll, produce payslips, and handle Real Time Information (RTI) submissions to HMRC. We also deal with auto-enrolment pension duties and notify you of PAYE payments due.",
    ...
    },
    {
      ...
      description: "Thinking of going limited? We can incorporate your company, set up the most tax-efficient structure from the start, and talk you through what being a limited company director actually involves day-to-day.",
    ...
    },
    {
      ...
      description: "Sometimes you just have a question. As a client of Ace Bookkeeping, you can pick up the phone or drop Andy an email whenever something comes up — no hourly rate ticking away while you speak.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-brand-slate text-lg">
            Practical, accurate financial services designed to save you time and remove the complexity from tax and compliance across Clevedon, Portishead, and Bristol.
          </p>
        </div>
        ...
        <div className="mt-16 text-center bg-brand-navy text-white p-10 rounded-2xl max-w-5xl mx-auto shadow-xl">
          <h3 className="text-2xl font-bold mb-3">Not sure which services your business needs?</h3>
          <p className="text-slate-300 mb-6 max-w-xl mx-auto text-sm">
            Get in touch with Andy for a quick, friendly chat about your setup and we can tailor a transparent package for you.
          </p>
